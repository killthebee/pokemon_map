...
class Pokemon(models.Model):
    ...
    title_en = models.CharField('Английское название покемона', max_length=20, null=True, blank=True)
    title_jp = models.CharField('Японское название покемона', null=True, blank=True)
